...
void main() {
  test('generates the service worker config for the Web app selected by FlutterFire', () async {
...
''',
    ...
    final generated = File(path.join(appRoot.path, 'web', 'firebase-config.js'))
        .readAsStringSync();
