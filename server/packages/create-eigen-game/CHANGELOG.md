...
- [#113](https://github.com/eigeninteractive/eigen-platform/pull/113) [`fc6286b`](https://github.com/eigeninteractive/eigen-platform/commit/fc6286be453dc6323febe93cae14180b118e92fe) Thanks [@seenu-k](https://github.com/seenu-k)! - Pin `tmp` to `0.2.7` in a scaffolded game, for both npm (`overrides`) and pnpm (`pnpm-workspace.yaml`). `workbox-cli` pulls it in transitively through `inquirer` and `external-editor`, pinned at `^0.0.33`, a range that excludes the fixed version.
...
- [#108](https://github.com/eigeninteractive/eigen-platform/pull/108) [`201e66a`](https://github.com/eigeninteractive/eigen-platform/commit/201e66a5eb8a5f1170c03a1cefb69111afe7cab3) Thanks [@seenu-k](https://github.com/seenu-k)! - A scaffolded game's web app opens offline from its first visit, and updates cleanly (decision 0014).
...
- [#105](https://github.com/eigeninteractive/eigen-platform/pull/105) [`ab1ab8b`](https://github.com/eigeninteractive/eigen-platform/commit/ab1ab8b7f7b9971bd0b919c2d78ba6de2d99080f) Thanks [@eigen-release](https://github.com/apps/eigen-release)! - Install the newly released Dart packages in a scaffolded app.
  
  - `eigen_flutter` ^0.13.0
  - `eigen_shell` ^0.5.0
  - `eigen_firebase` ^0.4.0

## 0.16.1

### Patch Changes

- [#99](https://github.com/eigeninteractive/eigen-platform/pull/99) [`12342ab`](https://github.com/eigeninteractive/eigen-platform/commit/12342ab87667ce5525a65c88e819610192da1f47) Thanks [@eigen-release](https://github.com/apps/eigen-release)! - Install the newly released Dart packages in a scaffolded app.
  
  - `eigen_flutter` ^0.12.0
  - `eigen_shell` ^0.4.0
...
- [#93](https://github.com/eigeninteractive/eigen-platform/pull/93) [`927376a`](https://github.com/eigeninteractive/eigen-platform/commit/927376a33b67f6aa598fe316597246ea341b9fd8) Thanks [@seenu-k](https://github.com/seenu-k)! - Scaffold the 0.8.x engine line against the Flutter packages that speak it:
...
- [`4e64633`](https://github.com/eigeninteractive/eigen-platform/commit/4e6463309479f7f14c41c17ef09951e1325f803e) Thanks [@seenu-k](https://github.com/seenu-k)! - Raise the scaffolded Flutter shell to `eigen_flutter ^0.7.0`, so both halves of a
...
- [`e7b6bf3`](https://github.com/eigeninteractive/eigen-platform/commit/e7b6bf35c976412681e15fd921df2c89bb1a96d1) Thanks [@seenu-k](https://github.com/seenu-k)! - Scaffold a game that declares its own seat range, against the 0.5 engine.
...
- [#62](https://github.com/eigeninteractive/eigen-server/pull/62) [`e8c537f`](https://github.com/eigeninteractive/eigen-server/commit/e8c537fd29bc0d8a6d0d252c41bd411692dab298) Thanks [@seenu-k](https://github.com/seenu-k)! - Install `eigen_flutter@^0.6.0` into the app half, matching the engine's 0.4.x line.
