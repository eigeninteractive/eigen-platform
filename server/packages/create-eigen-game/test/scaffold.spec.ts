...
describe("scaffoldGame", () => {
  ...
  it("uses ecosystem CLIs to bootstrap both halves", () => {
    ...
    expect(run).toHaveBeenCalledWith("flutter", ["pub", "add", "eigen_flutter@^0.10.0", "eigen_shell@^0.1.0", "eigen_firebase@^0.2.0", "firebase_core@^4.9.0"], expect.stringMatching(/\/app$/));
