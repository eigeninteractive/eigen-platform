...
- [#102](https://github.com/eigeninteractive/eigen-platform/pull/102) [`8b88a30`](https://github.com/eigeninteractive/eigen-platform/commit/8b88a30eb9bd88cc23e2f6516a2940a0670069fd) Thanks [@seenu-k](https://github.com/seenu-k)! - **Breaking.** A device now keeps a replica of its account and refreshes it with one request (decision 0013).
...
- Updated dependencies []:
  - @eigeninteractive/kernel@0.10.0
  - @eigeninteractive/rules@0.10.0
