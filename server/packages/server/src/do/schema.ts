...
export const meta = sqliteTable(
  "meta",
  {
    ...
    /** Copied from D1 at lazy init like the rest of this row, and immutable
     * after. This is the authoritative copy: it gates the local-origin trust
     * rule (a creator acting on their own bots' seats) and the suppression of
     * bot wakes and pushes, and a D1 row is a read model, never an arbiter. */
  ...
  (t) => [check("meta_origin_valid", sql`${t.origin} IN ('online', 'local')`)],
);
