...
export async function acknowledgeIfNeeded(d1: D1Database, adapter: CommerceProvider<unknown>, env: unknown, transaction: CommerceTransactionReference, now: () => number): Promise<void> {
