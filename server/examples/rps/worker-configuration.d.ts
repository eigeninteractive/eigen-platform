/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f37c2e1946e82ef8262e2918d674c69d)
// Runtime types generated with workerd@1.20260908.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	AVATARS: R2Bucket;
	rps_dev: D1Database;
	EIGEN_RATE_LIMIT_AVATAR_UPLOAD: RateLimit;
	EIGEN_RATE_LIMIT_GAME_CREATE: RateLimit;
	EIGEN_RATE_LIMIT_FRIEND_REQUEST: RateLimit;
	EIGEN_RATE_LIMIT_USER_SEARCH: RateLimit;
	ASSETS: Fetcher;
	FIREBASE_PROJECT_ID: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "WEB_APP_ORIGIN">> {}
}
