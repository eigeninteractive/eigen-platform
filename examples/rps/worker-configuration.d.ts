/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ee7db2be48adc97453d9a1bf3c8919f6)
// Runtime types generated with workerd@1.20260710.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	AVATARS: R2Bucket;
	rps_dev: D1Database;
	RATE_LIMIT_AVATAR_UPLOAD: RateLimit;
	RATE_LIMIT_GAME_CREATE: RateLimit;
	RATE_LIMIT_FRIEND_REQUEST: RateLimit;
	RATE_LIMIT_USER_SEARCH: RateLimit;
