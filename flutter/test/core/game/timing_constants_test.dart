...
void main() {
  group('softDeadlineMarginFor', () {
    test('returns the full margin for a comfortably long window', () {
      ...
      check(softDeadlineMarginFor(const Duration(seconds: 10)))
